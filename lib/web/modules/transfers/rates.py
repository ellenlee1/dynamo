...
class FileTransferRates(WebModule, HTMLMixin):
    """
    ...
    def __init__(self, config):
        WebModule.__init__(self, config)
        HTMLMixin.__init__(self, 'Current file transfers', 'transfers/rates.html')

        self.stylesheets = ['/css/transfers/monitor.css']
        self.scripts = ['/js/utils.js', '/js/transfers/rates.js', '/js/plotly-jan2018.min.js']
